...
export default function Header() {
  return (
    <header className="flex justify-between items-center px-3 xs:px-4 sm:px-6 lg:px-10 py-3 sm:py-4 sticky top-0 z-50 bg-white/80 backdrop-blur-xl backdrop-saturate-150 border-b border-gray-200/50 transition-colors duration-300">
