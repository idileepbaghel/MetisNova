...
export default function About() {
  return (
    <section
      id="about"
      className="relative py-28 px-6 scroll-mt-20 bg-gradient-to-b from-slate-50 via-white to-slate-100 overflow-hidden"
    >
      ...
      <div className="relative max-w-7xl mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          <div className="space-y-8">
            ...
            {/* Expertise Card */}
            <div className="p-8 rounded-2xl bg-white/80 backdrop-blur border border-gray-200 shadow-md hover:shadow-xl transition-all duration-300">
            ...
            {/* Approach Card */}
            <div className="p-8 rounded-2xl bg-gradient-to-br from-indigo-600 to-purple-600 text-white shadow-lg">
